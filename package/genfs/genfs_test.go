...
func TestSideBySideRoot(t *testing.T) {
	...
	// run the TestFS compliance test suite
	is.NoErr(fstest.TestFS(gfs, "a.txt", "b.txt"))
}
...
func TestSideBySideDir(t *testing.T) {
	...
	des, err := fs.ReadDir(gfs, "app")
	is.NoErr(err)
	is.Equal(len(des), 2)
	is.Equal(des[0].Name(), "a.txt")
	is.Equal(des[1].Name(), "b.txt")
	// run the TestFS compliance test suite
	is.NoErr(fstest.TestFS(gfs, "app/a.txt", "app/b.txt"))
}
...
// 	linker := &Linker{}
// 	bfs := genfs.New(cache, fsys, log)
// 	bfs.GenerateFile("bud/internal/web/view/view.go", func(fsys genfs.FS, file *genfs.File) error {
...
// 		return nil
// 	})
// 	bfs.GenerateFile("bud/internal/web/web.go", func(fsys genfs.FS, file *genfs.File) error {
...
// 	linker := &Linker{}
// 	bfs := genfs.New(cache, fsys, log)
// 	bfs.GenerateDir("bud/internal/node_modules", func(fsys genfs.FS, dir *genfs.Dir) error {
// 		_, err := fs.Stat(fsys, "node_modules")
// 		if err != nil {
// 			return err
// 		}
// 		count["bud/internal/node_modules"]++
// 		dir.GenerateFile("svelte.js", func(fsys genfs.FS, file *genfs.File) error {
...
// 	linker := &Linker{}
// 	bfs := genfs.New(cache, fsys, log)
// 	bfs.ServeFile("bud/internal/node_modules", func(fsys genfs.FS, file *genfs.File) error {
// 		count["bud/internal/node_modules"]++
// 		rel := file.Relative()
...
// 	cache := vcache.Discard
// 	linker := &Linker{}
// 	mountfs := genfs.New(cache, fsys, log)
// 	mountfs.GenerateFile("bud/generator/a.txt", func(fsys genfs.FS, file *genfs.File) error {
...
// 		return nil
// 	})
// 	mountfs.GenerateFile("bud/generator/b.txt", func(fsys genfs.FS, file *genfs.File) error {
...
// 		return nil
// 	})
// 	bfs.GenerateFile("b.txt", func(fsys genfs.FS, file *genfs.File) error {
...
// 	bfs := genfs.New(cache, fsys, log)
// 	count := map[string]int{}
// 	bfs.GenerateFile("bud/public/public.go", func(fsys genfs.FS, file *genfs.File) error {
